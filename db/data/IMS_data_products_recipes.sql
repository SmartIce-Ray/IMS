...
-- ============================================================================
-- 菌菇产品数据 (追加于 2025-12-01)
-- 来源: IMS_data_new_mushroom_products.sql
-- 内容: 4种原材料(RM-230~233) + 4个成品菜(FP-064~067) + 配方
-- ============================================================================
...
INSERT INTO product (
    ...
    is_saleable, is_ingredient, base_unit_id,
    current_cost_encrypted, cost_calculation_method,
    std_yield_rate, storage_condition,
    description, is_active
) VALUES (
    'RM-230',
    '龙爪菌',
    ...
    TRUE,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'g'),
    pgp_sym_encrypt('0.0500', current_setting('app.encryption_key')),
    'standard',
    0.95,
    '冷藏',
    '菌菇类原材料 | 25元/斤 | 称重采购',
    ...
    product_name = EXCLUDED.product_name,
    current_cost_encrypted = EXCLUDED.current_cost_encrypted,
    std_yield_rate = EXCLUDED.std_yield_rate,
    description = EXCLUDED.description,
    updated_at = NOW();
...
INSERT INTO product (
    ...
    TRUE,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'g'),
    pgp_sym_encrypt('0.0400', current_setting('app.encryption_key')),
    'standard',
    0.95,
    '冷藏',
    '菌菇类原材料 | 20元/斤 | 称重采购',
...
INSERT INTO product (
    ...
    TRUE,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'g'),
    pgp_sym_encrypt('0.0460', current_setting('app.encryption_key')),
    'standard',
    0.95,
    '冷藏',
    '菌菇类原材料 | 23元/斤 | 称重采购',
...
-- 1.4 滑菇 (RM-233) - 别名: 黄金菌
INSERT INTO product (
    product_code, product_name, short_name, product_type, category_id,
    is_saleable, is_ingredient, base_unit_id,
    current_cost_encrypted, cost_calculation_method,
    std_yield_rate, storage_condition,
    ...
    TRUE,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'g'),
    pgp_sym_encrypt('0.0240', current_setting('app.encryption_key')),
    'standard',
    0.95,
    '冷藏',
    '别名:黄金菌',
    '菌菇类原材料 | 12元/斤 | 称重采购 | 产品名"玉龙黄金菌"对应原材料',
    TRUE
) ON CONFLICT (product_code) DO UPDATE SET
    product_name = EXCLUDED.product_name,
...
-- ============================================================================
-- 2. 创建原材料SKU (product_sku表)
-- ============================================================================

-- 2.1 龙爪菌 SKU
INSERT INTO product_sku (
    product_id, sku_code, sku_name,
    package_spec, package_quantity, base_unit_quantity,
    package_unit_id, is_default, is_active,
    reference_price, reference_price_unit_id, reference_base_unit_price,
    notes
) VALUES (
    (SELECT product_id FROM product WHERE product_code = 'RM-230'),
    'RM-230-SKU-01',
    '龙爪菌-称重',
    '称重/斤',
    500,
    500,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'jin'),
    TRUE,
    TRUE,
    25.00,
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'jin'),
    ...
    reference_base_unit_price = EXCLUDED.reference_base_unit_price,
    updated_at = NOW();
...
INSERT INTO product_sku (
    ...
    (SELECT product_id FROM product WHERE product_code = 'RM-231'),
    'RM-231-SKU-01',
    '鸡枞菌-称重',
    '称重/斤',
    500,
...
INSERT INTO product_sku (
    ...
    (SELECT product_id FROM product WHERE product_code = 'RM-232'),
    'RM-232-SKU-01',
    '赤松茸-称重',
    '称重/斤',
    500,
...
INSERT INTO product_sku (
    ...
    (SELECT product_id FROM product WHERE product_code = 'RM-233'),
    'RM-233-SKU-01',
    '滑菇-称重',
    '称重/斤',
    500,
...
-- 3.1 怒山龙爪菌 (FP-064) - 售价28元, 成本6.50元
INSERT INTO product (
    product_code, product_name, product_type, category_id, brand_id,
    is_saleable, is_ingredient, selling_price,
    portion_size, portion_unit_id, base_unit_id,
    current_cost_encrypted, cost_calculation_method,
    description, is_active
) VALUES (
    'FP-064',
    ...
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    pgp_sym_encrypt('6.50', current_setting('app.encryption_key')),
    'standard',
    '菌菇类成品 | 原材料种类:1种 | 毛利率:76.79%',
    TRUE
) ON CONFLICT (product_code) DO UPDATE SET
    product_name = EXCLUDED.product_name,
...
-- 3.2 崇明黑鸡枞 (FP-065) - 售价32元, 成本7.72元
INSERT INTO product (
    product_code, product_name, product_type, category_id, brand_id,
    is_saleable, is_ingredient, selling_price,
    portion_size, portion_unit_id, base_unit_id,
    ...
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    pgp_sym_encrypt('7.72', current_setting('app.encryption_key')),
    'standard',
    '菌菇类成品 | 原材料种类:3种 | 毛利率:75.87%',
    TRUE
) ON CONFLICT (product_code) DO UPDATE SET
    product_name = EXCLUDED.product_name,
    selling_price = EXCLUDED.selling_price,
...
-- 3.3 文山赤松茸 (FP-066) - 售价32元, 成本8.62元
INSERT INTO product (
    product_code, product_name, product_type, category_id, brand_id,
    is_saleable, is_ingredient, selling_price,
    portion_size, portion_unit_id, base_unit_id,
    ...
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    pgp_sym_encrypt('8.62', current_setting('app.encryption_key')),
    'standard',
    '菌菇类成品 | 原材料种类:3种 | 毛利率:73.06%',
    TRUE
) ON CONFLICT (product_code) DO UPDATE SET
    product_name = EXCLUDED.product_name,
    selling_price = EXCLUDED.selling_price,
...
-- 3.4 玉龙黄金菌 (FP-067) - 售价28元, 成本4.08元
INSERT INTO product (
    product_code, product_name, product_type, category_id, brand_id,
    is_saleable, is_ingredient, selling_price,
    portion_size, portion_unit_id, base_unit_id,
    ...
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    (SELECT unit_id FROM unit_of_measure WHERE unit_code = 'serving'),
    pgp_sym_encrypt('4.08', current_setting('app.encryption_key')),
    'standard',
    '菌菇类成品 | 原材料种类:2种 | 毛利率:85.43% | 原材料:滑菇',
    TRUE
) ON CONFLICT (product_code) DO UPDATE SET
    product_name = EXCLUDED.product_name,
    selling_price = EXCLUDED.selling_price,
...
INSERT INTO recipe (
    recipe_code, product_id, version, recipe_name,
    effective_date, is_current, status,
    yield_quantity, yield_unit_id,
    total_cost_encrypted,
    brand_id, notes
) VALUES (
    'RCP-FP-064-V1',
    (SELECT product_id FROM product WHERE product_code = 'FP-064'),
    'v1.0',
    '怒山龙爪菌标准配方',
    '2025-11-28',
    TRUE,
...
INSERT INTO recipe (
    ...
    'RCP-FP-065-V1',
    (SELECT product_id FROM product WHERE product_code = 'FP-065'),
    'v1.0',
    '崇明黑鸡枞标准配方',
    '2025-11-28',
    TRUE,
    ...
    pgp_sym_encrypt('7.72', current_setting('app.encryption_key')),
    (SELECT brand_id FROM brand WHERE brand_code = 'BRAND-YBL'),
    '原材料:鸡枞菌150g+羽衣甘蓝90g+红叶生菜20g | 成本率:24.13%'
) ON CONFLICT (recipe_code) DO UPDATE SET
    recipe_name = EXCLUDED.recipe_name,
    total_cost_encrypted = EXCLUDED.total_cost_encrypted,
    notes = EXCLUDED.notes,
...
INSERT INTO recipe (
    ...
    'RCP-FP-066-V1',
    (SELECT product_id FROM product WHERE product_code = 'FP-066'),
    'v1.0',
    '文山赤松茸标准配方',
    '2025-11-28',
    TRUE,
    ...
    pgp_sym_encrypt('8.62', current_setting('app.encryption_key')),
    (SELECT brand_id FROM brand WHERE brand_code = 'BRAND-YBL'),
    '原材料:赤松茸150g+羽衣甘蓝90g+红叶生菜20g | 成本率:26.94%'
) ON CONFLICT (recipe_code) DO UPDATE SET
    recipe_name = EXCLUDED.recipe_name,
    total_cost_encrypted = EXCLUDED.total_cost_encrypted,
    notes = EXCLUDED.notes,
...
INSERT INTO recipe (
    ...
    'RCP-FP-067-V1',
    (SELECT product_id FROM product WHERE product_code = 'FP-067'),
    'v1.0',
    '玉龙黄金菌标准配方',
    '2025-11-28',
    TRUE,
...
DECLARE
    ...
    v_unit_id INT;
BEGIN
    SELECT recipe_id INTO v_recipe_id FROM recipe WHERE recipe_code = 'RCP-FP-064-V1';
    SELECT unit_id INTO v_unit_id FROM unit_of_measure WHERE unit_code = 'g';

    -- 龙爪菌 130g
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-230';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        subtotal_cost_encrypted, cost_percentage,
        is_main_ingredient
    ) VALUES (
        v_recipe_id, v_ingredient_id, 'raw_material', 1,
        130, v_unit_id,
        pgp_sym_encrypt('0.0500', current_setting('app.encryption_key')), 0.95,
        pgp_sym_encrypt('6.50', current_setting('app.encryption_key')), 100.00,
        TRUE
...
DECLARE
    ...
    v_unit_id INT;
BEGIN
    SELECT recipe_id INTO v_recipe_id FROM recipe WHERE recipe_code = 'RCP-FP-065-V1';
    SELECT unit_id INTO v_unit_id FROM unit_of_measure WHERE unit_code = 'g';

    -- 鸡枞菌 150g
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-231';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        ...
        v_recipe_id, v_ingredient_id, 'raw_material', 1,
        150, v_unit_id,
        pgp_sym_encrypt('0.0400', current_setting('app.encryption_key')), 0.95,
        pgp_sym_encrypt('6.00', current_setting('app.encryption_key')), 77.72,
        TRUE
    ) ON CONFLICT DO NOTHING;

    -- 羽衣甘蓝 90g (RM-091)
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-091';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        ...
        v_recipe_id, v_ingredient_id, 'raw_material', 2,
        90, v_unit_id,
        pgp_sym_encrypt('0.0160', current_setting('app.encryption_key')), 1.0,
        pgp_sym_encrypt('1.44', current_setting('app.encryption_key')), 18.65,
        FALSE
    ) ON CONFLICT DO NOTHING;

    -- 红叶生菜 20g (RM-092)
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-092';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        ...
        v_recipe_id, v_ingredient_id, 'raw_material', 3,
        20, v_unit_id,
        pgp_sym_encrypt('0.0140', current_setting('app.encryption_key')), 1.0,
        pgp_sym_encrypt('0.28', current_setting('app.encryption_key')), 3.63,
        FALSE
    ) ON CONFLICT DO NOTHING;
END $$;
...
DECLARE
    ...
    v_unit_id INT;
BEGIN
    SELECT recipe_id INTO v_recipe_id FROM recipe WHERE recipe_code = 'RCP-FP-066-V1';
    SELECT unit_id INTO v_unit_id FROM unit_of_measure WHERE unit_code = 'g';

    -- 赤松茸 150g
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-232';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        ...
        v_recipe_id, v_ingredient_id, 'raw_material', 1,
        150, v_unit_id,
        pgp_sym_encrypt('0.0460', current_setting('app.encryption_key')), 0.95,
        pgp_sym_encrypt('6.90', current_setting('app.encryption_key')), 80.05,
        TRUE
    ) ON CONFLICT DO NOTHING;
    ...
    INSERT INTO recipe_item (
        ...
        90, v_unit_id,
        pgp_sym_encrypt('0.0160', current_setting('app.encryption_key')), 1.0,
        pgp_sym_encrypt('1.44', current_setting('app.encryption_key')), 16.71,
        FALSE
    ) ON CONFLICT DO NOTHING;
    ...
    INSERT INTO recipe_item (
        ...
        20, v_unit_id,
        pgp_sym_encrypt('0.0140', current_setting('app.encryption_key')), 1.0,
        pgp_sym_encrypt('0.28', current_setting('app.encryption_key')), 3.25,
        FALSE
    ) ON CONFLICT DO NOTHING;
END $$;
...
DECLARE
    ...
    v_unit_id INT;
BEGIN
    SELECT recipe_id INTO v_recipe_id FROM recipe WHERE recipe_code = 'RCP-FP-067-V1';
    SELECT unit_id INTO v_unit_id FROM unit_of_measure WHERE unit_code = 'g';

    -- 滑菇 150g
    SELECT product_id INTO v_ingredient_id FROM product WHERE product_code = 'RM-233';
    INSERT INTO recipe_item (
        recipe_id, ingredient_id, ingredient_type, usage_sequence,
        quantity, unit_id,
        unit_price_encrypted, usage_yield_rate,
        ...
        v_recipe_id, v_ingredient_id, 'raw_material', 1,
        150, v_unit_id,
        pgp_sym_encrypt('0.0240', current_setting('app.encryption_key')), 0.95,
        pgp_sym_encrypt('3.60', current_setting('app.encryption_key')), 88.24,
        TRUE
    ) ON CONFLICT DO NOTHING;
    ...
    INSERT INTO recipe_item (
        ...
        30, v_unit_id,
        pgp_sym_encrypt('0.0160', current_setting('app.encryption_key')), 1.0,
        pgp_sym_encrypt('0.48', current_setting('app.encryption_key')), 11.76,
        FALSE
    ) ON CONFLICT DO NOTHING;
END $$;

-- ============================================================================
-- 6. 录入红叶生菜绵阳店采购价 (store_purchase_price表)
-- ============================================================================
...
BEGIN
    ...
    FROM store
    WHERE store_code = 'STORE-YBL-MY-001';

    -- 获取斤单位ID
    SELECT unit_id INTO v_jin_unit_id
    ...
    WHERE p.product_code = 'RM-092'
      AND ps.is_default = TRUE
    LIMIT 1;

    -- 如果SKU存在，录入采购价格
    IF v_sku_id IS NOT NULL AND v_store_id IS NOT NULL THEN
        INSERT INTO store_purchase_price (
            ...
            v_jin_unit_id,
            'manual_input',
            '红叶生菜当前采购价15元/斤，标准价7元/斤，差异率+114.3%，季节性波动'
        ) ON CONFLICT (store_id, sku_id, price_date) DO UPDATE SET
            purchase_price = EXCLUDED.purchase_price,
            notes = EXCLUDED.notes,
            updated_at = NOW();

        RAISE NOTICE '红叶生菜采购价格已录入: 绵阳店 15元/斤';
    ELSE
        RAISE NOTICE '未找到红叶生菜SKU或绵阳店，跳过采购价格录入';
    END IF;
END $$;
