...
-- 2. 品牌
-- ============================================================================
INSERT INTO brand (brand_code, brand_name, brand_name_en, brand_type, positioning, target_customer, is_active)
VALUES
...
INSERT INTO store (
    store_code, store_name, brand_id,
...
-- 5. 仓库（每个门店配一个门店仓库）
-- ============================================================================
INSERT INTO warehouse (warehouse_code, warehouse_name, warehouse_type, store_id, brand_id, is_active)
SELECT
    'WH-' || s.store_code,
    s.store_name || '仓库',
    'store',
